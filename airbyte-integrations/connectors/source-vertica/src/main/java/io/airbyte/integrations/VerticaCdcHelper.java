...
public class VerticaCdcHelper {
  ...
  static Properties getDebeziumProperties(final JsonNode config) {
    ...
    props.setProperty("converters", "vertica_converter");
    props.setProperty("vertica_converter.type", "io.airbyte.integrations.debezium.internals.VerticaConverter");
