...
public class VerticaCdcStateHandler implements CdcStateHandler {

  private static final Logger LOGGER = LoggerFactory.getLogger(VerticaCdcStateHandler.class);
  private final StateManager stateManager;

  public VerticaCdcStateHandler(final StateManager stateManager) {
  ...
  public AirbyteMessage saveState(final Map<String, String> offset, final String dbHistory) {
    ...
    state.put(VERTICA_CDC_OFFSET, offset);
    state.put(VERTICA_DB_HISTORY, dbHistory);
