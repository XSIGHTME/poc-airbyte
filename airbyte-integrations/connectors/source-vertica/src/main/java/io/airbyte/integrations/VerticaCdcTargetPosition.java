...
public class VerticaCdcTargetPosition implements CdcTargetPosition {

  private static final Logger LOGGER = LoggerFactory.getLogger(VerticaCdcTargetPosition.class);
  public final Lsn targetLsn;

  public VerticaCdcTargetPosition(final Lsn targetLsn) {
  ...
  public boolean equals(final Object o) {
    ...
    final VerticaCdcTargetPosition that = (VerticaCdcTargetPosition) o;
  ...
  public static VerticaCdcTargetPosition getTargetPosition(final JdbcDatabase database, final String dbName) {
    try {
      ...
      if (jsonNodes.get(0).get("max_lsn") != null) {
        ...
        return new VerticaCdcTargetPosition(maxLsn);
      } else {
